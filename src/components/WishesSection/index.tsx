    ...
    <section>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="sm:text-center md:text-left sm:mx-auto">
          <h2 className="mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl sm:leading-none text-center">
          ...
          <p className="text-base md:text-xl  text-purple-700 text-center mt-4 font-bold">
            Ну и, конечно, не забудьте взять с собой хорошее настроение!
          </p>
          <hr className="my-8 border-gray-300" />
          <div className='flex flex-col lg:flex-row items-center'>
            <div className='mb-6 lg:mb-0 lg:w-1/2 lg:pr-5'>
              <p className="font-bold text-4xl text-gray-900 text-center">
                До встречи!
              </p>
            </div>
            <div className="lg:w-1/2">
              <img alt='Яна и Эдик' src={Photo1} className="h-96 w-96 mask-heart mx-auto md:h-80 md:w-80 mt-8" />
            </div>
          </div>
        </div>
      </div>
